...
set style line 1 lc rgb '#E51D00' pt 1 ps 0.5 lt 1 lw 3.5

set style line 2 lc rgb '#DC6003' pt 2 ps 0.5 lt 1 lw 3.5

set style line 3 lc rgb '#D39B07' pt 3 ps 0.5 lt 1 lw 3.5

set style line 4 lc rgb '#C4CA0A' pt 4 ps 0.5 lt 1 lw 3.5
...
#plot  'ECC_lp800/run/0.1/output' u ($1*1e9):6 w l ls 3 t 'T=800 K'

plot    '../ECC500Anlaf/run/0.1/output' u ($1*1e9):($6*$5) w l ls 1 t 'T peak=500K', \
        'ECC_lp700/run/0.1/output' u ($1*1e9):($6*$7) w l ls 2 t 'T peak=700K',\
        'ECC_lp750/run/0.1/output' u ($1*1e9):($6*$7) w l ls 3 t 'T peak=750K'
